...
//				pageLanguage: 'zh-CN',
	...
	execute:function(){
		...
		/* 处理1.0 - 1.1 升级的 */
		if(translate.includedLanguages != 'en,fr,zh-CN'){
	...
	/**
	 * 获取当前页面采用的是什么语言
	 * 返回值如 en,fr,zh-CN （如果是第一次用，没有设置过，那么返回的是 translate.localLanguage 设置的值）		
	 */
	...
	/**
	 * 切换语言，比如切换为英语、法语
 	 * @param languageName 要切换的语言语种。传入如 en,fr,zh-CN
	 */
